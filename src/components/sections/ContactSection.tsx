            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">contacto@pmcontabilidad.com</p>
                  <p className="text-gray-600">soporte@pmcontabilidad.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Av. Insurgentes Sur 1234</p>
                  <p className="text-gray-600">Col. Del Valle, CDMX 03100</p>
                </div>
              </div>
