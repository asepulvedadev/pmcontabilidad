        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            ...
            <ul className="space-y-3">
              ...
              <li>
                <span className="text-gray-300">Declaraciones Fiscales</span>
              </li>
              <li>
                <span className="text-gray-300">Asesoría Contable</span>
              </li>
              <li>
                <span className="text-gray-300">Consultoría Fiscal</span>
              </li>
            </ul>
          </motion.div>
        </div>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="#"
                className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center text-gray-300 hover:bg-blue-400 hover:text-white transition-all duration-300"
                aria-label="Twitter"
              >
              ...
              <a
                href="#"
                className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center text-gray-300 hover:bg-pink-600 hover:text-white transition-all duration-300"
              ...
              <a
                href="#"
                className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center text-gray-300 hover:bg-blue-700 hover:text-white transition-all duration-300"
                aria-label="LinkedIn"
              >
